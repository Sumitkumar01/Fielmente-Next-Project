        ...
        <div className="w-[80%]">
          ...
          <div className="mt-14">
            <h2 className="text-5xl text-black font-bold">
              {BlogDetails.reviewImportant.title}
            </h2>
            <p className="text-black text-lg mt-6">
              {BlogDetails.reviewImportant.subtitle}
            </p>

            <ul className="mt-10 flex flex-col gap-4 text-xl text-black">
              {BlogDetails.reviewImportant.list.map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-14">
            <h2 className="text-5xl text-black font-bold">
              {BlogDetails.replyToGoogle.title}
            </h2>
            <p className="text-black text-lg mt-6">
              {BlogDetails.reviewImportant.subtitle}
            </p>
          ...
          <div className="mt-14">
            <h2 className="text-5xl text-black font-bold">
              {BlogDetails.positiveGoogleReviews.title}
            </h2>
            <p className="text-black text-lg mt-6">
              {BlogDetails.positiveGoogleReviews.subtitle}
            </p>

            <ul className="mt-10 flex flex-col gap-10 text-xl text-black">
              {BlogDetails.positiveGoogleReviews.content.map((item, i) => (
                <li className="flex flex-col gap-1" key={i}>
                  {item.title}
                  <p className="px-6">{item.subtitle}</p>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-14">
            <h2 className="text-5xl text-black font-bold">
              {BlogDetails.stratigies.title}
            </h2>
            <p className="text-black text-lg mt-6">
              {BlogDetails.stratigies.subtitle}
            </p>

            <ul className="mt-10 flex flex-col gap-4 text-lg text-black">
              {BlogDetails.stratigies.list.map((item, i) => (
                <li className="flex flex-col gap-1" key={i}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-14">
            <h2 className="text-5xl text-black font-bold">
              {BlogDetails.positiveReviews.title}
            </h2>
            <p className="text-black text-lg mt-6">
              {BlogDetails.positiveReviews.subtitle}
            </p>

            <ul className="mt-10 flex flex-col gap-14 text-lg text-black">
              {BlogDetails.positiveReviews.list.map((item, i) => (
                <li className="flex flex-col gap-1" key={i}>
                  <h2 className="font-bold">{item.title}</h2>
                  <p className=" mt-6">{item.subtitle}</p>
                  <h3 className="font-bold mt-6">{item.heading}</h3>
                  <p>{item.subheading}</p>

                  <h3 className="font-bold mt-6">{item.heading2}</h3>
                  <p className="mt-6">{item.subheading2}</p>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="mt-14">
            <h2 className="text-5xl text-black font-bold">
              {BlogDetails.negativeFeedBack.title}
            </h2>

            <ul className="mt-10 flex flex-col gap-5 text-lg text-black">
              {BlogDetails.negativeFeedBack.subtitle.map((item, i) => (
                <li className="flex flex-col gap-1" key={i}>{item}</li>
              ))}
            </ul>

            <ul className="mt-10 flex flex-col gap-14 text-lg text-black">
              {BlogDetails.negativeFeedBack.list.map((item, i) => (
                <li className="flex flex-col gap-1" key={i}>
                  <h2 className="font-bold">{item.title}</h2>
          ...
          <div className="mt-14">
            <h2 className="font-bold text-5xl text-black">
              {BlogDetails.Conclusion.title}
            </h2>
            <p className="text-black text-lg">
              {BlogDetails.Conclusion.subtitle}
            </p>
          </div>
